...
use soroban_sdk::{
    Bytes, BytesN, Env, String, Vec, contract, contractimpl, crypto::bn254::Bn254Fr, vec,
};
...
impl RiscZeroVerifierInterface for RiscZeroGroth16Verifier {
    ...
    fn verify_integrity(env: Env, receipt: Receipt) -> Result<(), VerifierError> {
        ...
        pub_signals.push_back(Bn254Fr::from_bytes(control_root_0));
        pub_signals.push_back(Bn254Fr::from_bytes(control_root_1));
        pub_signals.push_back(Bn254Fr::from_bytes(claim_0));
        pub_signals.push_back(Bn254Fr::from_bytes(claim_1));
        pub_signals.push_back(Bn254Fr::from_bytes(bn254_control_id));
