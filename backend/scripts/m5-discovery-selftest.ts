...
ok(sanitizeRoomText("Series\u202eA", ROOM_NAME_MAX) === "SeriesA", "strips bidi override (U+202E RLO)");
ok(sanitizeRoomText("a\u200bb\u200dc", ROOM_NAME_MAX) === "abc", "strips zero-width chars");
ok(sanitizeRoomText("a\ufeffb", ROOM_NAME_MAX) === "ab", "strips ZWNBSP (U+FEFF)");
ok(sanitizeRoomText("a\u0085b", ROOM_NAME_MAX) === "a b", "C1 control (U+0085 NEL) -> space");
