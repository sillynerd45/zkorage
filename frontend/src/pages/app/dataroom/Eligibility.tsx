    ...
    <div data-testid="dr2-card" className="space-y-5">
      ...
      <Card className="rounded-2xl border-brand/40 p-6">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          can't do this. It always learns who you are, and it can let you back in any time. That's the one thing
        ...
        >
          ...
          <div className="text-xs text-muted-foreground">
            claim type {e.memInfo?.claimType ?? "n/a"} · tree depth {e.memInfo?.treeDepth ?? "n/a"}
          </div>
          ...
          <div className="text-xs text-muted-foreground" data-testid="dr2-grants">
            ...
            {e.elig?.memberCount != null ? `${e.elig.memberCount} member(s)${e.elig.inSync ? " · in sync ✓" : ""}` : "n/a"}
          </div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Joins a fresh room anonymously, proves you belong (a few minutes), and gets you in. It then shows the
