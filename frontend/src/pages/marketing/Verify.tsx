  ...
  return (
    <>
      <PageHeader
        ...
        lead={
          <>
            <b>No wallet, and no need to trust our server.</b> This page recomputes the journal hash, checks the
            image-id pin, and asks the <b>public</b> Soroban contracts to confirm the Groth16 proof and the
            supply binding. That is exactly what anyone can reproduce with the CLI below. Reserves are never revealed.
          </>
        }
      />
